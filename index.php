...
?>
    <div class="wrapper">
        <div class="intro">
            ...
            <!--            					 Оказываем услуги мини сваебойной спецтехники-->
            <!--            				</p>-->
            <!--             <a href="/services/index.php">Подробнее</a>--> <!--            			</div>-->
            <!--            			<div class="service">--> <!--            				<p>-->
            <!--            					 Предлагаем услуги строительного консалтинга-->
            <!--            				</p>-->
            <!--             <a href="/services/index.php">Подробнее</a>--> <!--            			</div>-->
            <!--            			<div class="service">--> <!--            				<p>-->
            <!--            					 Изготавливаем--> <!--            				</p>-->
        ...
        <div class="features">
            ...
            ); ?> <!--			<div class="feature">--> <!--				<p>--> <!--					 Профессионализм-->
            <!--				</p>--> <!--				<p>--> <!--					 В нашей команде:-->
            <!--				</p>--> <!--				<p>-->
            <!--					 - Только профессиональные строители с опытом работы 13-15 лет;--> <!--				</p>-->
            <!--				<p>--> <!--					 - Собственная служба строительного контроля;-->
            <!--				</p>--> <!--				<p>-->
            <!--					 - Надёжные партнеры: лучшие изыскатели, проектировщики и поставщики г.Омска.-->
            <!--				</p>--> <!--			</div>--> <!--			<div class="feature">-->
            <!--				<p>-->
            <!--					 Надежность--> <!--				</p>--> <!--				<p>-->
            <!--					 Мы имеем собственное современное производственное и монтажное оборудование железобетонных и стальных конструкций.-->
            <!--				</p>--> <!--			</div>--> <!--			<div class="feature">-->
            <!--				<p>-->
            <!--					 Мобильность--> <!--				</p>--> <!--				<p>-->
            <!--					 Мы работаем:--> <!--				</p>--> <!--				<p>-->
            <!--					 - В удаленных районах;--> <!--				</p>--> <!--				<p>-->
            <!--					 - В стесненных условиях;--> <!--				</p>--> <!--				<p>-->
            <!--					 - В непосредственной близости от существующих строений;--> <!--				</p>-->
            <!--				<p>--> <!--					 - Круглый год.--> <!--				</p>-->
            <!--			</div>-->
        </div>
    </div>
